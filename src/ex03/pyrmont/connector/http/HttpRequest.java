...
/**
 * 此类从org.apache.catalina.connector.HttpRequestBase和org.apache.catalina.connector.http.HttpRequestImpl复制方法。
 * HttpRequestImpl 类使用了一个 HttpHeader 对象池来提高性能 这两个类将在第 4 章中解释。
 * <p>
